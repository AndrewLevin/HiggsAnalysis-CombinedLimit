...
class GeorgiMachacekPhysicsModel(AnomalousCouplingModel):
    def __init__(self):
...
#        self.modelBuilder.factory_('RooOneParameterModelScaling::Scaling_WWewk_wwssll8TeV2(param,"'+self.scaling_filename+'","aQGC_scaling3")')
        ...
        self.modelBuilder.factory_('RooGeorgiMachacekModelScaling::Scaling_WWjj_ch1(param,"'+self.scaling_filename+'","gm_scaling_bin_1")')
        self.modelBuilder.factory_('RooGeorgiMachacekModelScaling::Scaling_WWjj_ch2(param,"'+self.scaling_filename+'","gm_scaling_bin_2")')
        self.modelBuilder.factory_('RooGeorgiMachacekModelScaling::Scaling_WWjj_ch3(param,"'+self.scaling_filename+'","gm_scaling_bin_3")')
        self.modelBuilder.factory_('RooGeorgiMachacekModelScaling::Scaling_WWjj_ch4(param,"'+self.scaling_filename+'","gm_scaling_bin_4")')


        return scalerName
        

my_1d_model = GeorgiMachacekPhysicsModel()
