...
if (len(sys.argv) != 6 and len(sys.argv) != 8):
    print "format: python2.6 draw_gm_limt_plot.py output_file_name x_axis_label limit_label input_file_name label [input_file_name_2] [label_2]"
    print "exiting"
    sys.exit(0)
...
print "95% confidence limit:"+str(param_95_pos)
