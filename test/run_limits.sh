...
python2.6 refine_grid_1d.py /afs/cern.ch/user/a/amlevin/wg/2016/${operator}_scaling.root wg_${operator}_scaling_refined.root /eos/user/a/amlevin/www/tmp/ scaling_${operator} "c/#Lambda^{2} (TeV^{-2})"
