...
combineCards.py /afs/cern.ch/user/a/amlevin/wg/photon_pt_bin1.txt /afs/cern.ch/user/a/amlevin/wg/photon_pt_bin2.txt /afs/cern.ch/user/a/amlevin/wg/photon_pt_bin3.txt /afs/cern.ch/user/a/amlevin/wg/photon_pt_bin4.txt /afs/cern.ch/user/a/amlevin/wg/photon_pt_bin5.txt >& wg_datacard_${operator}.txt
python2.6 refine_grid_1d.py /afs/cern.ch/user/a/amlevin/wg/${operator}_scaling.root wg_${operator}_scaling_refined.root
